...
let OrdersController = class OrdersController {
    ...
    async getOrderHistory(req) {
        return this.ordersService.getOrderHistory(req.user._id);
    }
    async getOrderById(req, orderId) {
        return this.ordersService.getOrderById(req.user._id, orderId);
    }
    ...
    async updatePaymentStatus(orderId, body) {
        return this.ordersService.updatePaymentStatus(orderId, body.paymentMethod || 'card');
    }
};
